...
export const PMlabels = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
...
export const PMlineChartTitle = "DogeCoin US Dollars Price from Jan 1 2022 to Dec 1 2022";